        ...
        >
          <div className="modal-content">
            ...
            <div className="row">
                ...
                <div>
                  ...
                  <h6 style={{ color: "teal" }}>
                    ...
                    {!this.state[this.props.Voice.audioS3key]
                      ? "..."
                      : this.state[this.props.Voice.audioS3key].confidence}
                  </h6>
                  <h6 style={{ color: "teal" }}>
                    Error Rate:
                    {!this.state[this.props.Voice.audioS3key]
                      ? "..."
                      : this.state[this.props.Voice.audioS3key].error_rate}
                  </h6>
                </div>
                <audio
              ...
              <div className=" col s12 m6 l6">
                <h5>Text Info:</h5>
                <h6 style={{ color: "teal" }}>Text Content:</h6>
            ...
            <div>
              <div className="row">
                <a className="waves-effect waves-light btn red lighten-1 right">
